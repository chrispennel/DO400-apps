...
public class ShoppingCartTest {
    ...
    @Test
    void addingNewProductToEmptyCart() throws ProductNotFoundInCatalogException {
    ...
    @Test
    void addingMoreItemsOfProductAlreadyInCart() throws ProductNotFoundInCatalogException {
        this.cartService.addProduct(1,10);
